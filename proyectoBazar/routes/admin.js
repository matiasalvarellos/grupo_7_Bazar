...
/*CATEGORIAS*/  
router.get('/categories', authMiddlewares ,adminMiddlewares, adminController.createCategory );
router.post('/categories', validator.cat, adminController.storeCategory);
/*COLORES*/
router.get('/colors',authMiddlewares ,adminMiddlewares, adminController.createColor);
